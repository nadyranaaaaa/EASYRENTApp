...
public class MessageActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(userMessage.getText() != null){
                    if(!userMessage.getText().toString().equals("") && username != null){
                        mChatData.push().setValue(new ModelChat(userMessage.getText().toString(),username,System.currentTimeMillis()));
                    }
                }
            }
        });
    ...
    private void displayChatMessage() {
        ...
        FirebaseListAdapter<ModelChat> adapter = new FirebaseListAdapter<ModelChat>(this, ModelChat.class, R.layout.list_message, FirebaseDatabase.getInstance().getReference().child("chats").limitToLast(100)) {
            @Override
